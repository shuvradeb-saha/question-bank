...
public class QuestionPaperSqlProvider {
    ...
    public String insertSelective(QuestionPaper record) {
        ...
        if (record.getTotalMarks() != null) {
            sql.VALUES("total_marks", "#{totalMarks,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getInstituteName() != null) {
            sql.SET("institute_name = #{record.instituteName,jdbcType=VARCHAR}");
        }
        
        if (record.getTotalMarks() != null) {
            sql.SET("total_marks = #{record.totalMarks,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(QuestionPaper record) {
        ...
        if (record.getTotalMarks() != null) {
            sql.SET("total_marks = #{totalMarks,jdbcType=INTEGER}");
        }
