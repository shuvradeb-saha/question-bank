...
public class CQQuestionSqlProvider {
    ...
    public String insertSelective(CQQuestion record) {
        ...
        if (record.getApprovedBy() != null) {
            sql.VALUES("approved_by", "#{approvedBy,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getApprovedBy() != null) {
            sql.SET("approved_by = #{record.approvedBy,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(CQQuestion record) {
        ...
        if (record.getApprovedBy() != null) {
            sql.SET("approved_by = #{approvedBy,jdbcType=INTEGER}");
        }
