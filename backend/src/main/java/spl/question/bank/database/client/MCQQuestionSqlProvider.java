...
public class MCQQuestionSqlProvider {
    ...
    public String insertSelective(MCQQuestion record) {
        ...
        if (record.getRejectCause() != null) {
            sql.VALUES("reject_cause", "#{rejectCause,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getRejectCause() != null) {
            sql.SET("reject_cause = #{record.rejectCause,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(MCQQuestion record) {
        ...
        if (record.getRejectCause() != null) {
            sql.SET("reject_cause = #{rejectCause,jdbcType=VARCHAR}");
        }
