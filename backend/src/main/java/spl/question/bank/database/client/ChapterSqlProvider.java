...
import spl.question.bank.database.model.ChapterExample.Criteria;
import spl.question.bank.database.model.ChapterExample.Criterion;
...
public class ChapterSqlProvider {
     ...
     */
    public String countByExample(ChapterExample example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated Sun Jun 23 00:17:29 BDT 2019
     */
    public String deleteByExample(ChapterExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("chapter");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Sun Jun 23 00:17:29 BDT 2019
     */
    public String selectByExample(ChapterExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Chapter record = (Chapter) parameter.get("record");
        ChapterExample example = (ChapterExample) parameter.get("example");
     ...
     * @mbg.generated Sun Jun 23 00:17:29 BDT 2019
     */
    protected void applyWhere(SQL sql, ChapterExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
